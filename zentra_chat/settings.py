"""
Django settings for zentra_chat project.
...
CORS_ORIGIN_WHITELIST =  [
    "http://localhost:4200",
    "http://localhost:3000",
    "https://api.zenchat.com",
    "https://*.zenchat.com",
    "https://user.zenchat.com",
    "https://admin.zenchat.com",
    "http://localhost",
]


CORS_ALLOWED_ORIGIN_REGEXES = [
    r"^https://\w+\.zenchat\.com$",
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Zentra Chat  API',
    'DESCRIPTION': 'Zentra Chat-API',
    'VERSION': '1.0.0',
...
GRAPHENE = {
    ...
    "SCHEMA": "zentra_chat.schema.schema"
}
